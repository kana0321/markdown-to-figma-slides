...
theme system の設計は `docs/theme-design.md` を基準にしています。
...
使える built-in theme は `classic`、`minimal`、`gradient-blue` です。theme 設計や責務分割の詳細は `docs/theme-design.md`、具体的な実行手順は `skills/references/workflow.md` を参照してください。
...
| theme system の設計方針 | `docs/theme-design.md` |
| built-in theme の追加・調整 | `docs/theme-authoring.md` |
| multi-theme の見た目確認 | `docs/multi-theme-visual-qa.md` |
